...
const route = useRoute(); // Use Vue Router for route params
const jobId = route.params.id; // Get job ID from route params

// Form data
// bind form inputs to reactive object with v-model
// Match schema of data object in API
const form = reactive({
...
const handleSubmit = async () => {
  ...
  // Spread form object and company object
  const updatedJob = {
    ...form,
    company: {
      ...form.company,
